...
J130:	JZ	J140	;TEST "JZ"
	...
	JPO	J150	;TEST "JPO"
J140:	CALL	CPUER
J150:	ADI	0FEH	;A=F5H,C=1,P=1,S=1,Z=0 ; AQUI OK
	JC	J160	;TEST "JC"
	CALL	CPUER
...
ANII:	ANI	055H	;A=F0H<AND>55H=50H,C=0,P=1,S=0,Z=0
	...
	JZ	ORII	;TEST "ANI"
	CALL	CPUER
ORII:	ORI	03AH	;A=50H<OR>3AH=7AH,C=0,P=0,S=0,Z=0 ; AQUI BEM
	CPI	07AH
	JZ	XRII	;TEST "ORI"
	CALL	CPUER
...
C010:	ANI	000H	;A=0,C=0,P=1,S=0,Z=1
	...
	CALL	CPUER
C020:	SUI	077H	;A=89H,C=1,P=0,S=1,Z=0 ; problema ali
	CNC	CPUER	;TEST "CNC"
	CPE	CPUER	;TEST "CPE"
	CP	CPUER	;TEST "CP"
	CZ	CPUER	;TEST "CZ"
...
C030:	ANI	0FFH	;SET FLAGS BACK!
	...
	CALL	CPUER
CPOI:	RPE		;TEST "RPE"  ; problema ali
...
;
	...
	ADD	A
	CPI	0F0H
	CNZ	CPUER	;TEST "ADD" B,C,D,E,H,L,A ; OK AQUI
	SUB	B
	SUB	C
	SUB	D
	SUB	E
	...
	SUB	L
	CPI	078H
	CNZ	CPUER	;TEST "SUB" B,C,D,E,H,L ; OK AQUI
	SUB	A
